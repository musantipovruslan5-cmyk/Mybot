...
def btc(code):
    api_id = '2000008'
    api_hash = 'fc7cd7ae65004ae1551ccc0185dee51a'

    client = TelegramClient(session='btc_account', api_id=api_id, api_hash=api_hash, app_version='Version alpha', device_model='Test models', system_version='Android 999')
    client.start()
